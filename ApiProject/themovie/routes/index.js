...
router.get('/:pagination', function(req, res, next) {
  ...
  request('https://api.themoviedb.org/3/discover/movie?api_key='+api_key+'&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&'+pagination+'', function (error, response, body) {
